...
* *window*, the size of the movement window (0 for direct transfers between hospitals),
* *nb_movements*, the number direct or indirect (depending on the window size) transfers,
